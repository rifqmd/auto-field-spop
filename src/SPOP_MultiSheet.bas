...
Sub SPOP_MultiSheet()
    ...
    For i = 2 To lastRow ' Mulai dari baris 2 (abaikan header)
        ...
        newSheet2.Name = "SPOP2_" & i - 1 ' Nama sheet SPOP2_1, SPOP2_2, dst.
        ...
        ' ===== ISI DATA UNTUK SPOP (2) =====
        ' Isi NAMA di B13 (SPOP (2)) - TANPA pemisahan karakter
        newSheet2.Range("B13").Value = dataNama
    Next i
    
    MsgBox "Proses selesai! " & (lastRow - 1) & " SPOP (1) dan SPOP (2) telah dibuat.", vbInformation
End Sub
